...
public:
	...
	Cetus::Buffer vertexBuffer;
	Cetus::Buffer indexBuffer;
	uint32_t indexCount;

	Cetus::Buffer uniformBufferVS;
	...
	{
		windowdata.name = "Vulkan Example - Texture loading";
		camera.type = Camera::CameraType::lookat;
		camera.setPosition(glm::vec3(0.0f, 0.0f, -2.5f));
		camera.setRotation(glm::vec3(0.0f, 15.0f, 0.0f));
		camera.setPerspective(60.0f, (float)windowdata.width / (float)windowdata.height, 0.1f, 256.0f);
	}
	...
	void loadTexture()
	{
		...
		VkSamplerCreateInfo sampler = Cetus::initializers::samplerCreateInfo();
		...
		VkImageViewCreateInfo view = Cetus::initializers::imageViewCreateInfo();
	...
	void setupVertexDescriptions()
	{
		...
		vertices.bindingDescriptions[0] =
			Cetus::initializers::vertexInputBindingDescription(
		...
		vertices.attributeDescriptions[0] =
			Cetus::initializers::vertexInputAttributeDescription(
				VERTEX_BUFFER_BIND_ID,
				0,
		...
		vertices.inputState = Cetus::initializers::pipelineVertexInputStateCreateInfo();
	...
	void setupDescriptorPool()
	{
		...
		{
			Cetus::initializers::descriptorPoolSize(VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1),
			Cetus::initializers::descriptorPoolSize(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1)
		};

		VkDescriptorPoolCreateInfo descriptorPoolInfo =
			Cetus::initializers::descriptorPoolCreateInfo(
	...
	void setupDescriptorSetLayout()
	{
		std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings =
		{
			...
			Cetus::initializers::descriptorSetLayoutBinding(
		...
		VkDescriptorSetLayoutCreateInfo descriptorLayout =
			Cetus::initializers::descriptorSetLayoutCreateInfo(
		...
		VkPipelineLayoutCreateInfo pPipelineLayoutCreateInfo =
			Cetus::initializers::pipelineLayoutCreateInfo(
				&descriptorSetLayout,
				1);
	...
	void setupDescriptorSet()
	{
		VkDescriptorSetAllocateInfo allocInfo =
			Cetus::initializers::descriptorSetAllocateInfo(
				descriptorPool,
				&descriptorSetLayout,
				1);
		...
		{
			// Binding 0 : Vertex shader uniform buffer
			Cetus::initializers::writeDescriptorSet(
				descriptorSet,
				VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
				0,
	...
	void preparePipelines()
	{
		VkPipelineInputAssemblyStateCreateInfo inputAssemblyState =
			Cetus::initializers::pipelineInputAssemblyStateCreateInfo(
				VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST,
				0,
				VK_FALSE);

		VkPipelineRasterizationStateCreateInfo rasterizationState =
			Cetus::initializers::pipelineRasterizationStateCreateInfo(
		...
		VkPipelineColorBlendAttachmentState blendAttachmentState =
			Cetus::initializers::pipelineColorBlendAttachmentState(
				0xf,
				VK_FALSE);

		VkPipelineColorBlendStateCreateInfo colorBlendState =
			Cetus::initializers::pipelineColorBlendStateCreateInfo(
				1,
				&blendAttachmentState);

		VkPipelineDepthStencilStateCreateInfo depthStencilState =
			Cetus::initializers::pipelineDepthStencilStateCreateInfo(
				VK_TRUE,
				VK_TRUE,
		...
		VkPipelineMultisampleStateCreateInfo multisampleState =
			Cetus::initializers::pipelineMultisampleStateCreateInfo(
		...
		VkPipelineDynamicStateCreateInfo dynamicState =
			Cetus::initializers::pipelineDynamicStateCreateInfo(
		...
		shaderStages[0] = loadShader("src/texture/texture.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader("src/texture/texture.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);

		VkGraphicsPipelineCreateInfo pipelineCreateInfo =
			Cetus::initializers::pipelineCreateInfo(
				pipelineLayout,
				renderPass,
				0);
